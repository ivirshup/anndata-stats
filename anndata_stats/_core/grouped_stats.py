...
class GroupBy:
    ...
    **Implementation**
    ...
    def sparse_aggregator(
        ...
        """
        Form matrix A such that rows of A * X are weighted sums of groups of rows of X.
    ...
    def _extract_indices(self):
        ...
        # passed to count and count_mean_var to avoid re-extracting in the latter
